...
# --- Training Function ---
def train():
    print("Starting RoBERTa (custom) model training...")
    ...
    with mlflow.start_run(run_name="RoBERTa_Custom") as run:
        mlflow.log_param("model_type", "Custom_RoBERTa")
        ...
        plt.title("Custom RoBERTa Training Loss")
        loss_plot_path = "training_loss_roberta_custom.png"
        plt.savefig(loss_plot_path)
        mlflow.log_artifact(loss_plot_path, "plots")
        os.remove(loss_plot_path)

    print("RoBERTa (custom) model training finished.")
