...
# --- Training Function ---
def train():
    print("Starting DistilBERT (custom) model training...")
    ...
    with mlflow.start_run(run_name="DistilBERT_Custom") as run:
        mlflow.log_param("model_type", "Custom_DistilBERT")
        ...
        plt.title("Custom DistilBERT Training Loss")
        loss_plot_path = "training_loss_distilbert_custom.png"
        plt.savefig(loss_plot_path)
        mlflow.log_artifact(loss_plot_path, "plots")
        os.remove(loss_plot_path)

    print("DistilBERT (custom) model training finished.")
